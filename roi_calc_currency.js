...
var currency = getSelectedCurrency();
    ...
    $('input[name="calc_monthly_ticket_volume"]').val(ticketVolume);
    $('input[name="calc_tickets_solved_by_zowie"]').val(ticketsSolved);
    $('input[name="calc_savings_delivered"]').val(savingsDelivered);
    $('input[name="calc_cost_per_ticket"]').val(costPerTicket);
    $('input[name="calc_chats"]').val(chats);
    $('input[name="calc_calls"]').val(calls);
    $('input[name="calc_emails"]').val(emails);
    $('input[name="calc_number_of_agents"]').val(numberOfAgents);
    $('input[name="calc_agents_salary"]').val(agentsSalary);
 $('input[name="calc_currency"]').val(currency);
});
